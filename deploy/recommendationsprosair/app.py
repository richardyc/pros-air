...
def recommend(visited_places, friends, strangers, k):
...
def main():
	...
	suggestions = recommend(visited_places, friends, strangers, k)
	...
	for suggestion in suggestions:
		count = suggestion[0]
		loc_name = suggestion[1]
		pos_scores.append((count, loc_name))
	pos_scores.sort()
	sorted_suggestions = pos_scores
	for suggestion in sorted_suggestions:
		locations.append(suggestion[1])
